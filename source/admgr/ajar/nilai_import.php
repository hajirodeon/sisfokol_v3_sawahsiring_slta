...
if ($_POST['btnBTL'])
	...
	//re-direct
	$ke = "nilai.php?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&mapelkd=$mapelkd&rukd=$rukd&smtkd=$smtkd";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnIMx'])
	...
	if (empty($filex_namex))
		...
		$ke = "nilai.php?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&mapelkd=$mapelkd&rukd=$rukd&smtkd=$smtkd&s=import";
		pekem($pesan,$ke);
		exit();
		}
	else
