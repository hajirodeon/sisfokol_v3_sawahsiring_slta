...
if ($_POST['btnSMP'])
	...
	//re-direct
	$ke = "$filenya?swkd=$swkd&skkd=$skkd&tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&rukd=$rukd&smtkd=$smtkd&mapelkd=$mapelkd";
	xloc($ke);
	exit();
	}
...
if (empty($smtkd))
	...
	do
		...
		if ($std_mulo == "true")
			{
			echo '<option value="'.$filenya.'?swkd='.$swkd.'&skkd='.$skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'&skkd='.$skkd.'&mapelkd='.$std_kd.'">Muatan Lokal --> '.$std_pel.'</option>';
			}
		else
			{
			echo '<option value="'.$filenya.'?swkd='.$swkd.'&skkd='.$skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'&skkd='.$skkd.'&mapelkd='.$std_kd.'">'.$std_pel.'</option>';
			}
		}
