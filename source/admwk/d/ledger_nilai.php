...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'&skkd='.$skkd.'&smtkd='.$st_kd.'">'.$st_smt.'</option>';
	}
...
if (empty($smtkd))
	...
	{
	echo '[<a href="ledger_nilai_pdf.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'" target="_blank" title="Legger Nilai"><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>]';
	}
